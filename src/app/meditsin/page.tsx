...
const Basket = () => {
  ...
  return (
    <div className="bacround">
      ...
      <h1 className="ml-30 m-20 text-[48px]">
        Медецинское оборудование Draeger
      </h1>

      <div className="mb-4 flex items-center justify-center gap-6">
        <img className="h-[389px] w-[650px]" src={med1.src} alt="med1" />
        <img className="h-[389px] w-[650px]" src={med2.src} alt="med2" />
      </div>

      <div className="ml-[800px] w-[650px] text-[16px]">
        <p>
